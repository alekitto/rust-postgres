...
impl Inner {
    ...
    pub fn length(&self) -> i16 {
        match *self {
            ...
            Inner::Cid => 4,
            Inner::OidVector => -1,
            Inner::PgDdlCommand => -1,
            Inner::Json => -1,
            Inner::Xml => -1,
            Inner::XmlArray => -1,
            Inner::PgNodeTree => -1,
            Inner::JsonArray => -1,
            Inner::TableAmHandler => 4,
            Inner::Xid8Array => -1,
            Inner::IndexAmHandler => 4,
            Inner::Point => 16,
            Inner::Lseg => 32,
            Inner::Path => -1,
            Inner::Box => 32,
            ...
            Inner::NameArray => -1,
            Inner::Int2Array => -1,
            Inner::Int2VectorArray => -1,
            Inner::Int4Array => -1,
            Inner::RegprocArray => -1,
            Inner::TextArray => -1,
            Inner::TidArray => -1,
            Inner::XidArray => -1,
            Inner::CidArray => -1,
            Inner::OidVectorArray => -1,
            Inner::BpcharArray => -1,
            Inner::VarcharArray => -1,
            Inner::Int8Array => -1,
            Inner::PointArray => -1,
            Inner::LsegArray => -1,
            Inner::PathArray => -1,
            ...
            Inner::Float4Array => -1,
            Inner::Float8Array => -1,
            Inner::PolygonArray => -1,
            Inner::OidArray => -1,
            Inner::Aclitem => 12,
            Inner::AclitemArray => -1,
            Inner::MacaddrArray => -1,
            Inner::InetArray => -1,
            Inner::Bpchar => -1,
            Inner::Varchar => -1,
            Inner::Date => 4,
            Inner::Time => 8,
            Inner::Timestamp => 8,
            Inner::TimestampArray => -1,
            Inner::DateArray => -1,
            Inner::TimeArray => -1,
            Inner::Timestamptz => 8,
            Inner::TimestamptzArray => -1,
            Inner::Interval => 16,
            Inner::IntervalArray => -1,
            Inner::NumericArray => -1,
            Inner::CstringArray => -1,
            Inner::Timetz => 12,
            Inner::TimetzArray => -1,
            Inner::Bit => -1,
            Inner::BitArray => -1,
            ...
            Inner::Numeric => -1,
            Inner::Refcursor => -1,
            Inner::RefcursorArray => -1,
            Inner::Regprocedure => 4,
            Inner::Regoper => 4,
            Inner::Regoperator => 4,
            Inner::Regclass => 4,
            Inner::Regtype => 4,
            Inner::RegprocedureArray => -1,
            Inner::RegoperArray => -1,
            Inner::RegoperatorArray => -1,
            Inner::RegclassArray => -1,
            Inner::RegtypeArray => -1,
            Inner::Record => -1,
            Inner::Cstring => -2,
            Inner::Any => 4,
            Inner::Anyarray => -1,
            Inner::Void => 4,
            Inner::Trigger => 4,
            Inner::LanguageHandler => 4,
            Inner::Internal => -1,
            Inner::Anyelement => 4,
            Inner::RecordArray => -1,
            Inner::Anynonarray => 4,
            Inner::TxidSnapshotArray => -1,
            Inner::Uuid => 16,
            Inner::UuidArray => -1,
            Inner::TxidSnapshot => -1,
            Inner::FdwHandler => 4,
            Inner::PgLsn => 8,
            Inner::PgLsnArray => -1,
            Inner::TsmHandler => 4,
            Inner::PgNdistinct => -1,
            Inner::PgDependencies => -1,
            Inner::Anyenum => 4,
            Inner::TsVector => -1,
            Inner::Tsquery => -1,
            Inner::GtsVector => -1,
            Inner::TsVectorArray => -1,
            Inner::GtsVectorArray => -1,
            Inner::TsqueryArray => -1,
            Inner::Regconfig => 4,
            Inner::RegconfigArray => -1,
            Inner::Regdictionary => 4,
            Inner::RegdictionaryArray => -1,
            Inner::Jsonb => -1,
            Inner::JsonbArray => -1,
            Inner::AnyRange => -1,
            Inner::EventTrigger => 4,
            Inner::Int4Range => -1,
            Inner::Int4RangeArray => -1,
            Inner::NumRange => -1,
            Inner::NumRangeArray => -1,
            Inner::TsRange => -1,
            Inner::TsRangeArray => -1,
            Inner::TstzRange => -1,
            Inner::TstzRangeArray => -1,
            Inner::DateRange => -1,
            Inner::DateRangeArray => -1,
            Inner::Int8Range => -1,
            Inner::Int8RangeArray => -1,
            Inner::Jsonpath => -1,
            Inner::JsonpathArray => -1,
            Inner::Regnamespace => 4,
            Inner::RegnamespaceArray => -1,
            Inner::Regrole => 4,
            Inner::RegroleArray => -1,
            Inner::Regcollation => 4,
            Inner::RegcollationArray => -1,
            Inner::PgMcvList => -1,
            Inner::PgSnapshot => -1,
            Inner::PgSnapshotArray => -1,
            Inner::Xid8 => 8,
            Inner::Anycompatible => 4,
            Inner::Anycompatiblearray => -1,
            Inner::Anycompatiblenonarray => 4,
            Inner::AnycompatibleRange => -1,
            Inner::Int4multiRange => -1,
            Inner::NummultiRange => -1,
            Inner::TsmultiRange => -1,
            Inner::TstzmultiRange => -1,
            Inner::DatemultiRange => -1,
            Inner::Int8multiRange => -1,
            Inner::AnymultiRange => -1,
            Inner::AnycompatiblemultiRange => -1,
            Inner::PgBrinBloomSummary => -1,
            Inner::PgBrinMinmaxMultiSummary => -1,
            Inner::Int4multiRangeArray => -1,
            Inner::NummultiRangeArray => -1,
            Inner::TsmultiRangeArray => -1,
            Inner::TstzmultiRangeArray => -1,
            Inner::DatemultiRangeArray => -1,
            Inner::Int8multiRangeArray => -1,
